    ...
    <>
      <Dialog open={open} {...other}>
        ...
        <DialogContent >
          ...
          <Checkbox name="joyoKanjiSect4"  checked={selectedKanji.joyoKanjiSect4} onChange={handleCheck} />
          Joyo kanji section 4 ({catCount.joyoKanjiSect4})<br/>
